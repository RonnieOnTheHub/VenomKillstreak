local Bots = require('recorder/bots')

Replayer = class('Replayer')

function Replayer:__init(replayData, passenger, entry)
...
function Replayer:_eventPlayerEnterVehicle(event)
	...
	if self._passenger ~= nil then
		self._passenger:EnterVehicle(self._vehicles[event.vehicle], self._entry)
	end
end
